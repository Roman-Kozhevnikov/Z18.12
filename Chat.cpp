...
// finout.open(file, std::ios::in | std::ios::out | std::ios::binary);
// 	if (finout.is_open())
// 	{
// 		finout.seekg(0);
// 		std::cout << "Here are the current contents on the " << file << " file:\n";
// 		while (finout.read((char*)&_map_us, sizeof _map_us)){    
// 		       std::cout << "Entering to the map done\n";		
// 	           } 
// 	    if (finout.eof())
// 	        finout.clear();
// 	    else {
// 	      std::cerr << "Error in reading " << file << " file\n";
// 	     } 
	
// 	} else {
// 		std::cerr << file << "could not be opened -- return to main() \n";
// 	}
